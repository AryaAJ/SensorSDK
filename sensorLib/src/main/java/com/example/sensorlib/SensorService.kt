...
class SensorService : Service(), SensorEventListener {
    ...
    companion object {
        ...
        val KEY_ON_SENSOR_CHANGED_ACTION = "ON_SENSOR_CHANGED"
        val KEY_NOTIFICATION_STOP_ACTION = "NOTIFICATION_STOP"
    }
    ...
    private fun createNotification(direction: String, angle: Double): Notification {
        ...
        val contentIntent = PendingIntent.getActivity(
            ...
            Intent(this, Class.forName("com.example.sensorapp.MainActivity")),
            PendingIntent.FLAG_UPDATE_CURRENT
        )

        val stopNotificationIntent = Intent(this, ServiceListener::class.java)
